...
const bankAccounts = [
  {
    name: 'NGUYEN BA THUC',
    bank: 'Vietcombank',
    account: '0011004416213',
    qrUrl: 'https://img.vietqr.io/image/VCB-0011004416213-compact.png',
  },
  {
    name: 'NGUYEN THI VAN ANH',
    bank: 'VPBank',
    account: '9977871115',
    qrUrl: 'https://img.vietqr.io/image/VPB-9977871115-compact.png',
  },
];
      ...
      <div className="wedding-container">
        ...
        <div className="text-center mb-12">
          ...
          <p className="max-w-2xl mx-auto text-muted-foreground mt-4">
            Sự hiện diện của bạn là món quà quý giá nhất. Nếu bạn muốn gửi thêm lời chúc phúc, 
            ...
            <DialogContent className="max-w-lg bg-gradient-to-br from-background to-muted border-primary/20">
              <DialogHeader>
                <DialogTitle className="text-center">
                  <span className="font-script text-4xl text-primary">Mừng Cưới</span>
                </DialogTitle>
              </DialogHeader>
